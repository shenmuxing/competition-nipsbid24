...
class TestDataLoader:
    ...
    def _get_raw_data(self):
        ...
        if os.path.exists(self.raw_data_path):
            ...
            if self.file_path.endswith('.csv'):
                ...
                tem = pd.read_feather(self.file_path)
    ...
    def _get_test_data_dict(self):
        ...
        """
        grouped_data = self.raw_data.sort_values('timeStepIndex').groupby(['deliveryPeriodIndex', 'advertiserNumber','advertiserCategoryIndex'])
    ...
    def mock_data(self, key):
        ...
        budgt_i = data[data['timeStepIndex'] == data['timeStepIndex'].min()].iloc[0]['budget']
        cpa_i = data[data['timeStepIndex'] == data['timeStepIndex'].min()].iloc[0]['CPAConstraint']
        return num_timeStepIndex, pValues, pValueSigmas, leastWinningCosts, budgt_i, cpa_i
